 ...
 * @param[in] name The name assigned to the new block.
 * @param type Specifies how the block is allocated within the partition.  One of ::PspSysMemBlockTypes.
 * @param size Size of the memory block, in bytes.
 * @param[in] addr If type is `PSP_SMEM_Addr`, then addr specifies the lowest address allocate the block from.
 *
 * @returns The UID of the new block, `< 0` an error.
 *
 * @attention Requires linking to `pspsysmem_user` or `pspsysmem_kernel` stubs to be available.
 */
 ...
 *
 * @param blockid The UID of the block to free.
 *
 ...
 *
 * @param blockid The UID of the memory block.
 *
 ...
 *
 * @attention Requires linking to `pspsysmem_user` stub to be available.
 */
 ...
 *
 * @attention Requires linking to `pspsysmem_kernel` stub to be available.
 */
 ...
 * @param[out] info A pointer to the `PspSysmemPartitionInfo` structure
 *
 ...
 *
 * @param[in] addr Address to set protection on.
 ...
 * @param name The name assigned to the new heap.
 *
 * @returns The UID of the new heap, `< 0` on error.
 *
 * @attention Requires linking to `pspsysmem_kernel` stub to be available.
*/
