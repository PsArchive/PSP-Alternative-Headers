...
/**
  ...
  * @param[in] arg An argument passed to the interrupt handler.
  *
  * @return `< 0` on error.
  *
  * @attention Requires linking to `pspinterruptmanager` or `pspinterruptmanager_driver` stubs to be available.
  */
...
/**
 * @attention Requires linking to `pspinterruptmanager` stub to be available.
 */
 ...
 *
 * @attention Requires linking to `pspinterruptmanager_driver` stub to be available.
 */
 ...
 *
 * @attention Requires linking to `pspinterruptmanager_kernel` or `pspkernel_library` stub to be available.
 */
...
/**
 * @attention Requires linking to `pspinterruptmanager_kernel` stub to be available.
 */
...
/**
  ...
  * @param[in] handler A pointer to the handler.
  * @param[in] arg1    Unknown (probably a set of flags)
  * @param[in] arg2    Unknown (probably a common pointer)
  *
  * @return `0` on success.
  *
  * @attention Requires linking to `pspinterruptmanager_kernel` stub to be available.
...
/**
  ...
  *
  * @param intno The interrupt to disable.
  *
  * @return `0` on success.
  *
  * @attention Requires linking to `pspinterruptmanager_kernel` stub to be available.
 ...
 *
 * @param function The function point to query it's system call.
 *
