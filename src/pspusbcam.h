 ...
 *
 * @param[in] param A pointer to a `PspUsbCamSetupStillParam`.
 *
 ...
 *
 * @param[in] param A pointer to a `PspUsbCamSetupStillExParam`
 *
 * @return `0` on success, `< 0` on error.
 *
 * @attention Requires linking to `pspusbcam` or `pspusbcam_driver` stubs to be available.
 ...
 * has been acquired.
 *
 * @param[out] buf The buffer that receives the image jpeg data.
 ...
 *
 * @param[in] param A pointer to a `PspUsbCamSetupVideoParam` structure.
 * @param[inout] workarea A pointer to a buffer used as work area by the driver.
 * @param wasize The size of the work area.
 *
 * @return `0` on success, `< 0` on error
 *
 * @attention Requires linking to `pspusbcam` or `pspusbcam_driver` stubs to be available.
 ...
 *
 * @param[in] param A pointer to a `PspUsbCamSetupVideoExParam` structure.
 * @param[inout] workarea A pointer to a buffer used as work area by the driver.
 * @param wasize The size of the work area.
 *
 * @return `0` on success, `< 0` on error
 ...
 * has been acquired.
 *
 * @param[out] buf The buffer that receives the frame jpeg data
 * @param size The size of the buffer.
 *
 * @return The size of acquired frame on success, `< 0` on error
 *
 * @attention Requires linking to `pspusbcam` or `pspusbcam_driver` stubs to be available.
*/
 ...
 * Sets the contrast.
 *
 * @param contrast The contrast value (0-255)
 *
 * @return `0` on success, `< 0` on error.
 *
 * @attention Requires linking to `pspusbcam` or `pspusbcam_driver` stubs to be available.
 ...
 * Sets the sharpness.
 *
 * @param sharpness The sharpness value (0-255)
 *
 * @return `0` on success, `< 0` on error.
 *
 * @attention Requires linking to `pspusbcam` or `pspusbcam_driver` stubs to be available.
 ...
 *
 * @param[out] brightness A pointer to a variable that receives the current brightness.
 *
 * @return `0` on success, `< 0` on error.
 *
 * @attention Requires linking to `pspusbcam` or `pspusbcam_driver` stubs to be available.
 ...
 *
 * @param[out] contrast A pointer to a variable that receives the current contrast.
 *
 * @return `0` on success, `< 0` on error.
 *
 * @attention Requires linking to `pspusbcam` or `pspusbcam_driver` stubs to be available.
 ...
 *
 * @param[out] sharpness A pointer to a variable that receives the current sharpness.
 *
 * @return `0` on success, `< 0` on error.
 *
 * @attention Requires linking to `pspusbcam` or `pspusbcam_driver` stubs to be available.
 ...
 *
 * @param[out] effectmode A pointer to a variable that receives the current effect mode.
 *
 * @return `0` on success, `< 0` on error.
 *
 * @attention Requires linking to `pspusbcam` or `pspusbcam_driver` stubs to be available.
 ...
 *
 * @param[out] ev A pointer to a variable that receives the current exposure level.
 *
 * @return `0` on success, `< 0` on error.
 *
 * @attention Requires linking to `pspusbcam` or `pspusbcam_driver` stubs to be available.
 ...
 *
 * @param[out] reverseflags A pointer to a variable that receives the current reverse mode flags.
 *
 * @return `0` on success, `< 0` on error.
 *
 * @attention Requires linking to `pspusbcam` or `pspusbcam_driver` stubs to be available.
 ...
 *
 * @param[out] zoom A pointer to a variable that receives the current zoom.
 *
 * @return `0` on success, `< 0` on error.
 *
 * @attention Requires linking to `pspusbcam` or `pspusbcam_driver` stubs to be available.
 ...
 * of the camera.
 *
 * @param on Pass `1` to set the automatic reversal of the image, `0` to set it off.
 *
 * @return `0` on success, `< 0` on error.
 *
 * @attention Requires linking to `pspusbcam` or `pspusbcam_driver` stubs to be available.
 ...
 *
 * @param[in] param A pointer to a `PspUsbCamSetupMicExParam` structure.
 * @param[inout] workarea A pointer to a buffer used as work area by the driver.
 * @param wasize The size of the work area.
 *
 * @return `0` on success, `< 0` on error.
