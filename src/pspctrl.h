 ...
 *
 * pspctrl.h - Prototypes for the sceCtrl and sceCtrl_driver libraries.
 *
...
enum SceCtrlButtons {
	...
	/** L3 button. */
	SCE_CTRL_L3			= 0x000002,
	/** R3 button. */
	SCE_CTRL_R3			= 0x000004,
	/** Start button. */
	...
	/** L2 button. */
	SCE_CTRL_L2			= 0x000100,
	/** R2 button. */
	SCE_CTRL_R2			= 0x000200,
	/** L1 button. */
	SCE_CTRL_L1			= 0x000400,
	/** R1 button. */
	SCE_CTRL_R1			= 0x000800,
	/** Triangle button. */
	...
	SCE_CTRL_HOME       = 0x010000,
	/** Hold button. */
	SCE_CTRL_HOLD       = 0x020000,
	/** Music Note button. */
	...
	/** Wlan switch up. */
	SCE_CTRL_WLAN_UP    = 0x040000,
	/** Remote hold position. */
	SCE_CTRL_REMOTE     = 0x080000,
	/** Disc present. */
...
typedef enum SceCtrlButtons PspCtrlButtons;
...
typedef struct {
     ...
     */
    u32 timestamp;
    /** The currently pressed button. Bitwise OR'ed values of `SceCtrlButtons`. */
    u32 buttons;
 ...
 * `sceCtrlReadLatch()`. `SceCtrlButtons` can be used to find out the state of each button.
 *
 ...
 *
 * @param cycle The cycle. Normally set to `0`.
 *
 ...
 *
 * @param[out] curr_cycle A pointer to hold the current cycle value.
 *
 * @return `0`.
 */
 ...
 *
 * @param mode The controller mode. One of `SceCtrlMode`.
 *
 ...
 *
 * @param[out] mode A pointer to hold the current controller mode.
 *
 * @return `0`.
 */
