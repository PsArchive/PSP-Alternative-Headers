...
typedef struct _pspUtilityGameSharingParams {
    ...
    u32 unknown1;							/* Set to 0 */
	u32 unknown2;							/* Set to 0 */
	char name[8];
	u32 unknown3;							/* Set to 0 */
	u32 unknown4;							/* Set to 0 */
	u32 unknown5;							/* Set to 0 */
	...
	u32 datasize;					/* Size of the EBOOT data in memory */
...
#endif /* __PSPUTILITY_GAMESHARING_H__ */
